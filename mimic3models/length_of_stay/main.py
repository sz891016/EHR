...
#print(val_reader.read_example(3))
...
if args.deep_supervision:
    print('===>Loading train data_gen deep')
    ...
    print('===>Loading test data_gen deep')
...
if args.mode == 'train':
    ...
    history=model.fit_generator(generator=train_data_gen,
                        ...
                        verbose=1)
    plot_model(model,to_file='LOSmodeltrain.png')
