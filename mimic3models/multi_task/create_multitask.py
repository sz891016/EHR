...
def process_partition(args, 
    ...
    with open(os.path.join(output_dir, "listfile.csv"), "w") as listfile:
        header = ','.join(['filename', 'length of stay', 'in-hospital mortality task (pos;mask;label)', 'length of stay task (masks;labels)'])
        ...
        for index in range(len(file_names)):
            ...
            listfile.write(','.join([file_name, los, ihm_task, los_task]) + "\n")
