...
from eicubenchmark.readers import InHospitalMortalityReader
...
parser.add_argument('--data', type=str, help='Path to the data of in-hospital mortality task',
                    default=os.path.join(os.path.dirname(__file__), '../../data/combin_in-hospital-mortality/'))
...
if args.mode == 'train':
    ...
    tensorboard = TensorBoard(log_dir='./mimic3models/combin_in_hospital_mortality/tensorboard_logs/', histogram_freq=1,write_graph=True)
    ...
    history = model.fit(x=train_raw[0],
              ...
              verbose=1,
              batch_size=args.batch_size)
    plot_model(model,to_file='modeltrain.png')
