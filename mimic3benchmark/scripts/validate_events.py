...
def main():
    ...
    for (index, subject) in enumerate(subjects):
        ...
        #读取stays.csv文件夹中的内容，不按列索引，dtype指定列数据类型
        ...
        #events_df.shape[0]：events_df的行数
        ...
        #dropna(subset=['HADM_ID'])：删除指定列中包含缺失值的行
